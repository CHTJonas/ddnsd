...
build/linux/armv7: dir mod
	...
	export GOARCH=arm
	export GOARM=7
	$(GOBUILD) -o bin/ddnsd-linux-$(VER:v%=%)-armv7 main.go

build/linux/arm64: dir mod
	export CGO_ENABLED=0
	export GOOS=linux
	export GOARCH=arm64
	$(GOBUILD) -o bin/ddnsd-linux-$(VER:v%=%)-arm64 main.go

build/linux/386: dir mod
	export CGO_ENABLED=0
	export GOOS=linux
	export GOARCH=386
	$(GOBUILD) -o bin/ddnsd-linux-$(VER:v%=%)-386 main.go

build/linux/amd64: dir mod
	export CGO_ENABLED=0
	export GOOS=linux
	export GOARCH=amd64
	$(GOBUILD) -o bin/ddnsd-linux-$(VER:v%=%)-amd64 main.go
...
build/freebsd/armv7: dir mod
	...
	export GOARCH=arm
	export GOARM=7
	$(GOBUILD) -o bin/ddnsd-freebsd-$(VER:v%=%)-armv7 main.go

build/freebsd/arm64: dir mod
	export CGO_ENABLED=0
	export GOOS=freebsd
	export GOARCH=arm64
	$(GOBUILD) -o bin/ddnsd-freebsd-$(VER:v%=%)-arm64 main.go

build/freebsd/386: dir mod
	export CGO_ENABLED=0
	export GOOS=freebsd
	export GOARCH=386
	$(GOBUILD) -o bin/ddnsd-freebsd-$(VER:v%=%)-386 main.go

build/freebsd/amd64: dir mod
	export CGO_ENABLED=0
	export GOOS=freebsd
	export GOARCH=amd64
	$(GOBUILD) -o bin/ddnsd-freebsd-$(VER:v%=%)-amd64 main.go
...
build/openbsd/armv7: dir mod
	...
	export GOARCH=arm
	export GOARM=7
	$(GOBUILD) -o bin/ddnsd-openbsd-$(VER:v%=%)-armv7 main.go

build/openbsd/arm64: dir mod
	export CGO_ENABLED=0
	export GOOS=openbsd
	export GOARCH=arm64
	$(GOBUILD) -o bin/ddnsd-openbsd-$(VER:v%=%)-arm64 main.go

build/openbsd/386: dir mod
	export CGO_ENABLED=0
	export GOOS=openbsd
	export GOARCH=386
	$(GOBUILD) -o bin/ddnsd-openbsd-$(VER:v%=%)-386 main.go

build/openbsd/amd64: dir mod
	export CGO_ENABLED=0
	export GOOS=openbsd
	export GOARCH=amd64
	$(GOBUILD) -o bin/ddnsd-openbsd-$(VER:v%=%)-amd64 main.go
...
build/darwin/arm64: dir mod
	...
	export GOOS=darwin
	export GOARCH=arm64
	$(GOBUILD) -o bin/ddnsd-darwin-$(VER:v%=%)-arm64 main.go

build/darwin/amd64: dir mod
	export CGO_ENABLED=0
	export GOOS=darwin
	export GOARCH=amd64
	$(GOBUILD) -o bin/ddnsd-darwin-$(VER:v%=%)-amd64 main.go
...
build/windows/386: dir mod
	...
	export GOOS=windows
	export GOARCH=386
	$(GOBUILD) -o bin/ddnsd-windows-$(VER:v%=%)-386 main.go

build/windows/amd64: dir mod
	export CGO_ENABLED=0
	export GOOS=windows
	export GOARCH=amd64
	$(GOBUILD) -o bin/ddnsd-windows-$(VER:v%=%)-amd64 main.go
